...
const data = [
{
  ...
  content: (
    <div className="text-sm text-neutral-600 dark:text-neutral-300 leading-relaxed">
      An AI-powered RAG (Retrieval-Augmented Generation) system designed to extract relevant legal clauses from massive contract databases in real time. Built using <strong>OpenAI GPT-4</strong>, <strong>ChromaDB</strong> for vector search, and <strong>LangChain</strong> for pipeline orchestration, the tool allows law firms to query in natural language and instantly retrieve matching clauses, legal summaries, or context-specific risk alerts.

      <br /><br />
      I trained the system using real legal templates, integrated a clause-level embedding model, and deployed a production-grade backend in <strong>TypeScript</strong> with full-text and vector-based querying. Ideal for legal analysts, compliance teams, and contract auditors.

      <br /><br />
      <span className="text-blue-500">Tech Stack:</span> OpenAI GPT-4, LangChain, ChromaDB, TypeScript, Node.js, TailwindCSS
    </div>
  )
},
  {
